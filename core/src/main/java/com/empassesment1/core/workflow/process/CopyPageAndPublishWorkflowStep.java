...
@Component(
    ...
    property = {
        ...
        "process.label=Copy Page and Publish" // Workflow step label
    }
)
public class CopyPageAndPublishWorkflowStep implements WorkflowProcess {
    ...
    public void execute(WorkItem workItem, WorkflowSession workflowSession, MetaDataMap metaDataMap) throws WorkflowException {
        ...
        String destinationPath = "/content/empassesment1/lan/fr-fr"; // Target Path
